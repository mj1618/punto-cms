...
class PageSummaryAttachmentsDeleteForm extends FormController {

    function __construct(){
        $this->controllerClass = 'PageSummaryAttachmentsDeleteForm';
        $this->header = 'Delete Attachment';
        $this->baseRoute = '/admin/manage-pages/{id1}/posts/{id2}/attachments/{id3}/delete';
//        $this->plainPage=true;
        $this->suffix='';
        $this->infoMessages = [''];
